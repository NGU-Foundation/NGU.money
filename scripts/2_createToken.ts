...
//! Token Template Testnet
// 5df7f20232395018acc88986433efea270b8593129f9881ca21ed909e00dbb01

//! Mainnet Token Template
// 1bdf91ae939427949daf79bad5a92a2b4974f84d4cd2b3a0686dd38b7b73a400
...
const tokenCreate: DeployFunction<Settings> = async (
  ...
  const result = await deployer.deployContract(CreateToken, {
    ...
    initialFields: {
      ...
      contract: "5df7f20232395018acc88986433efea270b8593129f9881ca21ed909e00dbb01"
    }
  })
